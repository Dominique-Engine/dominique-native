#define STB_IMAGE_IMPLEMENTATION // TODO avoid this here to be able to use stb_image in more places easily
...
SDL_Surface* DEngine::loadImgFromFile2SDLSurface( const char* filename, const int req_format)
{
